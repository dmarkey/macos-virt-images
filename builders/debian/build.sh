...
debootstrap --components=main,restricted,universe,multiverse --arch=$DEBIAN_ARCH --include="$PACKAGES,netplan.io,openssh-server,sudo,sshfs,initramfs-tools" "$RELEASE" "$ROOT"
